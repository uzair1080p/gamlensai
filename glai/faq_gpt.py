...
All AI FAQ functionality now uses the gamlens pipeline.
"""
...
def get_faq_gpt(*args, **kwargs):
    """DEPRECATED: Use gamlens/lib/ai.py instead"""
    warnings.warn(
        "glai.faq_gpt.get_faq_gpt is deprecated. "
        "Use gamlens.lib.ai.ask_one_question instead.",
        DeprecationWarning,
        stacklevel=2
    )
    raise NotImplementedError(
        "This function has been deprecated. Please use gamlens/lib/ai.py for AI FAQ functionality."
    )
