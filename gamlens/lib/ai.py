...
def ask_one_question(api_key: Optional[str], question: str, payload: dict,
    ...
    if is_roas_question:
        system = (
            ...
            "- For human-readable output, ALWAYS present ROAS and retention as PERCENTAGES with a % sign, rounded to 1–2 decimals (e.g., 0.48 → 48.0%).\n"
            ...
            "Do NOT interpret missing future-day ROAS as zero; treat them as unknown and project from earlier points.\n"
            ...
            "---\n\n"
            "Your output must be easy to scan by business users, using percentages and plain language. Start with ONE clean headline line, then bullets. Follow EXACTLY this structure (text, not JSON):\n\n"
            "---\n"
            "Headline: Current ROAS <percentage> → Break-even Day <n> (~<date range>), Projected Final ROAS <percentage>\n\n"
            "Summary (layman terms, 2–4 bullets):\n"
            "- Current ROAS: <percentage>\n"
            "- Projected final ROAS: <percentage>\n"
            "- Break-even timing: Day <n> (≈ <date range>)\n"
            "- Confidence/assumption note\n\n"
            "Key Figures:\n"
            "- Average ROAS (now): <percentage>\n"
            "- Projected ROAS (final): <percentage>\n"
            "- CPI: $<value> | ARPU: $<value>\n\n"
            "Daily projection (percentages):\n"
            "- Day 0: <percentage>\n"
            "- Day 1: <percentage>\n"
            "- Day 3: <percentage>\n"
            "- Day 7: <percentage>\n"
            ...
            "- Day 21: <percentage>\n"
            "- Day 30: <percentage>\n\n"
            "Recommended Actions (match the projection):\n"
            "- If projected final ROAS ≥ 1.0 and break-even ≤ 30 days: Continue and scale cautiously; double down on top channels/geos.\n"
            "- If projected final ROAS ≈ 0.7–0.99: Optimize (creative/audience/bids); cut the bottom 20% spend and re-test.\n"
            "- If projected final ROAS < 0.7 or growth has stalled: Pause/hold spend and reallocate to better performers.\n"
            "---\n\n"
        ...
        system = (
            ...
            "For human readability, ALWAYS present ROAS and retention as percentages with a % sign, rounded to 1–2 decimals. "
